        ...
        <div id="detail-header" class="detail-header">
            ...
            <div class="name-right">
                ...
                <div class="function-container">
                    <button class="edit-delete-btn" onclick="editContactBtn(${i})"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="edit-delete-btn" onclick="deleteContact(${i})"><svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
